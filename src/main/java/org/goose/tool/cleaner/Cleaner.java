...
/**
 * 功能描述： Copyright: Copyright (c) 2015 
 * Company: 电子科技大学 
 * Author: MaoKai Version:
 * 1.0 Time:2015/4/11 17:12
 */
public class Cleaner {
	...
	public Document removeBadNodes(Document original) {
		...
		String css = "^side$|combx|retweet|mediaarticlerelated|menucontainer|"
				...
				+ "|cnn_stryspcvbx|^inset$|pagetools|post-attributes" + "|welcome_form|contentTools2|the_answers"
